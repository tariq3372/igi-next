            ...
            <div id='fabrics' class="container py-10 lg:pb-10 lg:pt-28">
                <div class="flex flex-wrap w-full mb-10">
                    <div class="lg:w-1/2 w-full mb-6 lg:mb-0">
                        <h1 class="sm:text-3xl text-2xl font-medium title-font mb-2 text-tulip-yellow">{t("fabric")} </h1>
                        <div class="h-1 w-20 bg-tulip-yellow rounded"></div>
                    </div>
                    <p class="lg:w-1/2 w-full leading-relaxed text-magic-potion">{t("fabricContent")}</p>
                </div>

                <div class="mb-5">
                    <div class="w-full mb-2 lg:mb-0 flex flex-row flex-wrap items-center">
                        <h1 class="w-1/4 lg:w-2/12 sm:text-xl text-lg font-medium title-font mb-2 text-gray-900">{t("fabricTypes")}</h1>
                ...
                <div class="grid gap-5 grid-cols-1 md:grid-cols-4" >
                    ...
                    <div class="">
                        ...
                        {/* </Link> */}
                        <h2 class="text-lg text-center text-gray-900 font-medium title-font mb-4">{t("fabric01")}</h2>
                    ...
                    {/* <Link to="/plain sateen"> */}
                        ...
                        {/* </Link> */}
                        <h2 class="text-lg text-center text-gray-900 font-medium title-font mb-4">{t("fabric02")}</h2>
                    ...
                    {/* </Link>    */}
                        <h2 class="text-lg text-center text-gray-900 font-medium title-font mb-4">{t("fabric03")}</h2>
