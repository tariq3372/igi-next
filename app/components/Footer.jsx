      ...
      <div className=" mb-0 max-h-screen max-w-screen-xl">
        ...
        <div className="sm:flex text-blacks sm:items-center sm:justify-between">
          ...
          <div className='flex items-center md:justify-between mx-auto w-full'>
            ...
            <span className="invisible md:visible font-montserrat text-justify text-xs sm:text-sm sm:text-center text-gray-800">© 2023 <a href="#home" className="hover:underline">Imran Gulf Industries. F. Co.</a> - All Rights Reserved.
            </span>
        ...
        <div className='block md:hidden'>
          <p className="mb-3  w-full  font-montserrat text-xs text-center text-gray-800">© 2023 <a href="#home" className="hover:underline">Imran Gulf Industries. F. Co.</a>
          </p>
